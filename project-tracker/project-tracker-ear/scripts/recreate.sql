DROP TABLE IF EXISTS IBRAIN_USER CASCADE;
DROP TABLE IF EXISTS IBRAIN_GROUP CASCADE;
DROP TABLE IF EXISTS IBRAIN_BOOTSTRAP_VERSION CASCADE;
DROP TABLE IF EXISTS IBRAIN_USER_GROUP CASCADE;
DROP TABLE IF EXISTS IBRAIN_USER_PHONE CASCADE;

CREATE TABLE IBRAIN_USER (ID SERIAL NOT NULL, EMAIL VARCHAR(255) UNIQUE NOT NULL, USERNAME VARCHAR(64) UNIQUE, PASSWORD VARCHAR(255), FULLNAME VARCHAR(255), PRIMARY KEY (ID));
